/********************************************************************\
  ...
  $Id: fgdAndtsr.c 3702 2007-06-07 18:59:30Z amaudruz $
...
char code node_name[] = "FGDTSR-008";
...
MSCB_INFO_VAR code vars[] = {
   ...
   4, UNIT_CELSIUS,         0, 0, MSCBF_FLOAT, "ExtTemp",  &user_data[0].external_temp, //11

   //Hidden variables (wth "read all" call)
   4, UNIT_CELSIUS,         0, 0, MSCBF_FLOAT | MSCBF_HIDDEN, "TempOS",  &user_data[0].external_tempOffset, //12(hidden)
   4, UNIT_CELSIUS,         0, 0, MSCBF_FLOAT | MSCBF_HIDDEN, "IntTemp",  &user_data[0].internal_temp, //13(hidden)
