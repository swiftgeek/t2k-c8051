...
#define ADT7486A_ADDR_ARRAY0 0x49   //0x4B for the first board, 0x4C for the 2nd Board with green tag on
#define ADT7486A_ADDR_ARRAY1 0x48	// also define number of temperature sensors you have on board (final design would be 4 ADT7486A's, 8 Remote)
#define ADT7486A_ADDR_ARRAY2 0x4B
#define ADT7486A_ADDR_ARRAY3 0x4A
#define ADT7486A_NUM 4				  //currently, for the prototype, there is only one
