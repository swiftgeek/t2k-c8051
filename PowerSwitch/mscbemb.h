...
#define RF_GPIB_310
#endif
#ifdef generic_io_310      // 
#define GENERIC_IO_310
#endif
#ifdef generic_io_310_daq      // GPIB
#define GENERIC_IO_310_DAQ
#endif
...
#define MSCB_SST1 P2 ^ 0 //SST_IO line

#define SST_ClientResponse (char) ((CPT0CN & 0x40) >> 6) //Comparator0 overflow bit
                            //this way prevents us having to define a port pin
                            //as comparator 0 output
...
/*--------------------------------*/
#elif defined(GENERIC_IO_310_REV0)  
#include <c8051F310.h>
#define CPU_C8051F310
#define SUCCESS 0
#define FAILED  -1
...
/*--------------------------------*/
#elif defined(GENERIC_REV2) //ADC+DAC+SST
#include <c8051F310.h>
#define CPU_C8051F310
#define SUCCESS 0
#define FAILED  -1
...
/*--------------------------------*/
#elif defined(GENERIC_IO_310_REV0_SHT) //internal ADC+Humidity sensors+SST
#include <c8051F310.h>
#define CPU_C8051F310
#define SUCCESS 0
#define FAILED  -1
...
#define MSCB_SST1 P3 ^ 4 //SST1 line  SST_IO (Write/Push-Pull)
#define SST_ClientResponse1 (char) ((CPT1CN & 0x40) >> 6) //Comparator1 overflow bit
// #define SST2_ClientResponse P2 ^ 7 //Comparator 1 output

//SHTxx
#define SHT_DATA P2 ^ 4
#define SHT_SCK  P2 ^ 3
