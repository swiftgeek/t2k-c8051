...
#elif defined(BERTAN_375)
	P0MDIN = 0xFF;						// all digital pins
	P1MDIN = 0xFF;
	P2MDIN = 0xFF;
	P3MDIN = 0xFF;
	
	P0MDOUT = 0x16;					// ACLK, DEN (rs485), TX
	P1MDOUT = 0x7B;					// SPI_DOUT, SPI_CLK, CS1-4
	P2MDOUT = 0xC0;					// LED0-1, DAC_OUT1-2
	P3MDOUT = 0x18;					// TRIP_RESET1-2
	
	P0 = 0xC9;							// RX is set to an Input
	P1 = 0xF8;								// CS1-4 start high
	P2 = 0xFF;
	P3 = 0x19;

	P0SKIP  = 0x01;					// SKIP P0.0 so PCA (CEX0) uses P0.1 instead

	PCA0CPM0 = 0x06;					// Enable Frequency Output Mode
	PCA0CPH0 = 0x01;					// Fpca / (2 * PCA0CPH) = Fcex0
	PCA0CN = 0x40;						// Enable PCA Counter/Timer
	XBR1 = 0x41;				     // Enable crossbar & CEX0
//#elif defined(MSCB_GPIB)
